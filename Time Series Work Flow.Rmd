...
The name of the column you are interested in should be formatted as a 
...
transform_comparison(train, column, train_stats)
...
Un-comment below code to henceforth point the transformed data to the "column" variable.
